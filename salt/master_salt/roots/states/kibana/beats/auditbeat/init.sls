# https://artifacts.elastic.co/downloads/beats/auditbeat/auditbeat-6.0.1-linux-x86_64.tar.gz
# https://www.elastic.co/downloads/beats/auditbeat

# Download and unpack Auditbeat

# Edit the auditbeat.yml configuration file

# Start the daemon by running sudo ./auditbeat -e -c auditbeat.yml

# Dive into our getting started guide: https://www.elastic.co/guide/en/beats/auditbeat/6.0/auditbeat-getting-started.html
